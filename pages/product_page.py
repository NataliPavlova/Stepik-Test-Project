...
class ProductPage(BasePage):
    ...
    def product_price(self):
        product_price_element = self.browser.find_element(*ProductPageLocators.PRODUCT_PRICE_ELEMENT)
        product_price = product_price_element.text
        return product_price

    def message_product_price_in_basket(self):
        product_price_element_in_basket = self.browser.find_element(*ProductPageLocators.PRODUCT_PRICE_MESSAGE_IN_BASKET)
